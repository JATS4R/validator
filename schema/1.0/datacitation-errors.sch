...
<pattern id="datacitation-errors" 
  ...
  <rule context="mixed-citation | element-citation">
    ...
    <report test="@publication-type='data' and ((not(source) and not(data-title)) or (article-title and not(data-title)))"> 
  ...
  <rule context="year[ancestor::mixed-citation or ancestor::element-citation]">
	 ...
	 <j4r:meta rec='rec4' test-file='data-citations.xml'/>
      ERROR: &lt;year> in a citation must be a valid 4-digit year. "<value-of select="."/>" was supplied
		</assert>
  </rule>
